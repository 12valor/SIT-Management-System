...
- **🛡️ Role-Based Access Control (RBAC):** Distinct, secure portals tailored for Students, Industry Supervisors, and University Coordinators.
- **⏱️ Digital Logbook & DTR:** Seamless, high-precision digital tracking for Daily Time Records and granular task execution.
...
## 🏗️ Architectural Guidelines & Standards
