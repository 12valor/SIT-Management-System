      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 flex items-center gap-4 z-20">
        <Link href="/login" className="flex items-center gap-3 opacity-80 hover:opacity-100 transition-opacity">
          ...
          <div className="flex flex-col leading-none">
             ...
             <span className="text-[8px] font-semibold text-muted-foreground/60 uppercase tracking-widest">Admin Portal</span>
          </div>
        </Link>
      </div>
        ...
        <div className="max-w-[420px] w-full">
          ...
          <div className="bg-card dark:bg-white/[0.03] border border-border dark:border-white/5 p-10 rounded-3xl shadow-2xl shadow-black/5">
            ...
            <div className="mb-10 text-center">
              <div className="h-14 w-14 bg-red-500/10 rounded-2xl flex items-center justify-center text-red-600 mx-auto mb-6">
                <ShieldAlert className="h-7 w-7" />
              </div>
              <h2 className="text-3xl font-bold text-foreground font-heading tracking-tight uppercase mb-2">Admin</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="email" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Admin Identifier</label>
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50 group-focus-within:text-red-600 transition-colors" />
                  <input
                    id="email"
                    type="email"
                    required
                    ...
                    className="w-full h-12 pl-12 pr-4 bg-muted dark:bg-white/5 border border-border dark:border-white/10 rounded-xl text-[13px] font-medium outline-none focus:border-red-500/50 transition-all placeholder:text-muted-foreground/30"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <label htmlFor="password" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Secure Passkey</label>
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50 group-focus-within:text-red-600 transition-colors" />
                  <input
                    id="password"
                    type="password"
                    required
            ...
            <div className="mt-10 pt-8 border-t border-border dark:border-white/5 flex flex-col items-center gap-3 text-center">
               <div className="flex items-center gap-2">
                  <ShieldCheck className="w-3.5 h-3.5 text-red-600" />
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Active Audit Log</span>
               </div>
               <p className="text-[10px] font-medium text-muted-foreground/60 max-w-[200px]">
