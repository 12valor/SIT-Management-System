    ...
    <div className="flex-1 flex flex-col pt-24 pb-12 relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-[420px] w-full">
          ...
          <div className="bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 p-10 rounded-3xl shadow-2xl shadow-red-900/5 dark:shadow-none">
            {/* FORM HEADER */}
            <div className="mb-10 text-center">
              <div className="h-14 w-14 bg-red-50 dark:bg-red-900/10 rounded-2xl flex items-center justify-center text-red-600 mx-auto mb-6">
                <ShieldAlert className="h-7 w-7" />
              </div>
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white font-heading tracking-tight uppercase mb-2">Admin</h2>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full h-12 pl-12 pr-4 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-xl text-[13px] font-medium outline-none focus:border-red-400 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700"
                  />
                </div>
              </div>
            ...
            <div className="mt-10 pt-8 border-t border-slate-100 dark:border-white/5 flex flex-col items-center gap-3 text-center">
