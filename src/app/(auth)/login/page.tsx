      ...
      >
        <motion.header className="mb-16 text-center md:text-left border-b border-slate-200 dark:border-white/10 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-8" variants={fadeUp}>
          <div className="space-y-3">
            <span className="text-sm font-semibold tracking-[0.15em] text-primary dark:text-red-400 uppercase">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {roles.map((role) => (
            <motion.div key={role.title} variants={fadeUp} className="h-full">
              <Link 
                href={role.href}
                className="group flex flex-col h-full bg-white dark:bg-[#1A242D] border border-slate-200 dark:border-white/10 p-8 rounded-xl transition-all hover:border-primary/30 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)]"
              >
                <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-[#FAFAF7] dark:bg-[#0F1923] border border-slate-100 dark:border-white/5 mb-6 text-slate-600 dark:text-slate-400 group-hover:text-primary dark:group-hover:text-red-400 transition-colors">
                  <role.icon className="w-6 h-6" strokeWidth={1.5} />
                </div>
                
                <div className="flex-1 space-y-3">
                  <h3 className="text-xl font-serif font-medium text-slate-900 dark:text-[#F5F0E8] group-hover:text-primary dark:group-hover:text-red-400 transition-colors">
                    {role.title}
                  </h3>
                ...
                <div className="mt-10 flex items-center gap-3 text-sm font-medium text-slate-500 dark:text-slate-500 group-hover:text-primary dark:group-hover:text-red-400 transition-colors">
        ...
        <motion.footer className="mt-20 text-center" variants={fadeUp}>
          ...
          <Link 
            href="/faq"
            className="group relative inline-flex items-center justify-center h-14 px-10 bg-primary dark:bg-red-900 text-white font-bold rounded-full overflow-hidden transition-all active:scale-95 shadow-lg shadow-primary/20"
          >
