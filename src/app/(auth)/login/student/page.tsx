      ...
      <div className="max-w-md w-full relative z-10 px-6">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-black/50 border border-white/10 backdrop-blur-sm">
          <div className="mb-10 text-center md:text-left">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 mb-2 font-heading uppercase">Student Login</h2>
            <p className="text-sm text-slate-500 font-medium font-sans">Authorized access for registered TUP-V students.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-[10px] font-bold uppercase tracking-widest text-slate-500 font-heading ml-1">University Email</label>
          ...
          <footer className="mt-12 pt-8 border-t border-slate-100 flex items-center justify-between">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest font-heading">New here?</span>
