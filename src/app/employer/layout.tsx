  ...
  if (status === "loading" || !session) {
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 gap-4">
         <Briefcase className="h-12 w-12 text-blue-600 animate-pulse" />
         <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Verifying Partner Credentials...</p>
      </div>
    );
  }

  return (
    <div className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950 selection:bg-blue-500/20">
      {/* Mobile Backdrop */}
      {isMobileMenuOpen && (
        <div 
      ...
      <aside className={cn(
        ...
        <div className="absolute top-0 left-0 w-32 h-32 bg-blue-600/5 blur-[60px] rounded-full pointer-events-none" />
        
        <div className="flex h-24 items-center border-b border-slate-100 dark:border-slate-800 px-8 gap-4 relative z-10">
          <div className="w-11 h-11 bg-blue-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-600/20">
            <Building2 className="text-white h-6 w-6" />
          </div>
          <div className="flex flex-col">
            <span className="font-black text-xl tracking-tighter leading-none text-slate-900 dark:text-white uppercase italic">PARTNER.HUB</span>
            <span className="text-[9px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-[0.3em] mt-2">Industrial Portal</span>
          </div>
          <button 
        ...
        <div className="flex-1 overflow-y-auto px-5 py-10 relative z-10">
           <div className="px-5 mb-6">
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-600 mb-6">Management Matrix</h3>
           </div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive 
                      ? "bg-blue-600 text-white shadow-2xl shadow-blue-600/30 scale-[1.02]" 
                      : "text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-blue-500/5 hover:text-slate-950 dark:hover:text-white"
                  )}
                >
                  <div className="flex items-center gap-4 relative z-10">
                    <item.icon className={cn(
                      "h-5 w-5 transition-all duration-500",
                      isActive ? "text-white scale-110" : "text-slate-300 group-hover:text-blue-600"
                    )} />
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 p-8 space-y-6 relative z-10">
          <div className="p-5 rounded-[2rem] bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50 shadow-inner">
             <p className="text-[9px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-1.5">Compliance Level</p>
             <div className="flex items-center gap-3">
                <div className="h-2.5 w-2.5 rounded-full bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]" />
                <span className="text-[11px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-tight">Active Partner</span>
             </div>
          </div>
          <button
      ...
      <div className="flex flex-col flex-1 lg:pl-72">
        <header className="sticky top-0 z-40 flex h-24 items-center gap-6 border-b border-slate-100 dark:border-slate-800 bg-white/70 dark:bg-slate-950/70 backdrop-blur-2xl px-8 lg:px-12">
          ...
          <div className="flex-1">
            <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-[0.4em] mb-1.5 leading-none">Industrial Partner manifest</p>
          ...
          <div className="flex items-center gap-5">
            <button className="relative h-12 w-12 rounded-[1.25rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-center transition-all hover:bg-slate-50 dark:hover:bg-slate-800 hover:scale-110 shadow-sm group">
              ...
              <span className="absolute top-3.5 right-3.5 h-2.5 w-2.5 rounded-full bg-blue-600 border-2 border-white dark:border-slate-950 shadow-lg shadow-blue-600/30" />
            </button>
            <ThemeToggle />
            ...
            <div className="flex items-center gap-5 pl-2">
               <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] text-blue-600 dark:text-blue-400 mt-2 uppercase font-black tracking-widest leading-none">Supervisor</p>
               </div>
               <div className="h-14 w-14 rounded-[1.5rem] bg-blue-600 flex items-center justify-center text-white text-lg font-black shadow-2xl shadow-blue-600/20 ring-4 ring-white dark:ring-slate-900 transition-all hover:scale-105">
