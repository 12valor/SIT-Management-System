  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <div key={stat.label} className="group p-6 rounded-xl bg-card border border-border hover:border-blue-600/30 transition-all hover:shadow-xl hover:shadow-blue-600/5 relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
              ...
              {recentApps.length > 0 ? recentApps.map((app) => (
                <div key={app.id} className="p-5 flex items-center justify-between hover:bg-muted/30 transition-colors">
                  <div className="flex items-center gap-4">
                    <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center text-white text-xs font-bold leading-none">
        ...
        <div className="space-y-6">
           <h3 className="text-xl font-bold flex items-center gap-2 mb-2">
            ...
            <div className="p-6 rounded-xl bg-slate-900 text-white shadow-2xl space-y-6 relative overflow-hidden">
            ...
            <div className="p-6 rounded-xl border border-dashed border-border bg-card flex flex-col items-center justify-center text-center space-y-3 group cursor-pointer hover:border-blue-600/50 transition-colors">
