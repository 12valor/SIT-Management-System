        ...
        <div className="space-y-12 pb-24">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider">Pending Student Access</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pendingStudents.length > 0 ? pendingStudents.map(renderUserCard) : (
                <div className="col-span-full py-16 text-center rounded-xl border border-dashed border-border bg-muted/30">
                  <p className="text-xs font-semibold text-foreground/40 uppercase tracking-widest">No pending students</p>
                </div>
              )}
            </div>
          </div>
