...
export function Footer() {
  ...
  return (
    <footer className={`relative z-10 w-full ${isAuthRoute ? "py-12 bg-transparent" : "pt-24 pb-12 bg-slate-50 border-t border-slate-100"}`}>
      <div className="container mx-auto px-6">
        <div className={isAuthRoute ? "bg-white rounded-xl border border-slate-200 shadow-xl shadow-slate-200/40 p-8 md:p-12 overflow-hidden" : ""}>
