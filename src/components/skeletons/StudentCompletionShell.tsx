           ...
           <div className="relative z-10 grid md:grid-cols-3 items-center gap-10">
              <div className="md:col-span-2 space-y-6">
                 ...
                 <p className="text-slate-400 font-medium text-sm leading-relaxed max-w-xl">
                   Congratulations, {studentName.split(' ')[0]}. You have successfully synchronized all industrial records. Your final performance is permanently archived under <span className="text-white font-bold">{evaluationData?.companyName}</span>.
                 </p>
